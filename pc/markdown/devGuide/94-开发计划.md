...
<span style="color:red;">2024/4/1 - 2024/4/3 开发计划：</span>  
**开发人员：秦鹏飞，张园因，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">ScrollTo 滚动导航组件
	- <input type="checkbox">Switch 开关
2. ⭐⭐组件迭代
	- 复选框组件  
		· <input type="checkbox" checked>解决支付宝小程序checkboxGroup.value更新不触发计算属性的问题
3. ⭐⭐⭐完善组件预览网站
	- <input type="checkbox">留言功能增加风控，外网能够使用
	- <input type="checkbox">贡献人员介绍能够跳转，看到静态页面介绍
	- <input type="checkbox">增加支付宝和微信小程序预览
4. 组件替换
