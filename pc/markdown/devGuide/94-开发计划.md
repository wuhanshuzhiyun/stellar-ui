...
<span  style="color:red;">2024/08/12 - 2024/08/16 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐组件移植
	- <input type="checkbox">Rite 评分
	- <input type="checkbox">Table 表格
	- <input type="checkbox">Tabs 标签页
	- <input type="checkbox">MediaPreview 媒体预览
	- <input type="checkbox">TouchSwipe 手势切屏
2. ⭐⭐⭐组件迭代
	- 表格组件  
		· <input type="checkbox">增加行列合并功能
		· <input type="checkbox">表格添加自定义类名和样式(表头行、行)、高亮行、表头显隐藏等功能
		· <input type="checkbox">表格调整选择框大小
		· <input type="checkbox">表格添加选择项图标颜色的配置
	- 下拉组件  
