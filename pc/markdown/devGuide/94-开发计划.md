...
4. ⭐<input type="checkbox">ste-uniapp-vue2-template模版添加内部数据采集埋点 SDK功能（Stellar-Sensors）
5. ⭐<input type="checkbox">了解，预研vscode插件，为后续开发组件库的vscode插件做准备
5. ⭐<input type="checkbox">后续功能，计划探讨和研究


<span  style="color:red;">2024/09/18 - 2024/09/20 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐组件移植
2. ⭐⭐⭐组件迭代 
3. ⭐持续优化网站功能和文档
	- <input type="checkbox">vue3：评论功能服务端
	- <input type="checkbox">vue2：小程序登录报错解决
