...
1. ⭐⭐⭐<input type="checkbox">完成5个左右组件的开发，2个模块开发
...
<span  style="color:red;">2024/06/03 - 2024/06/07 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
...
2. ⭐⭐组件迭代
	...
	- 轮播组件    
		...
		· <input type="checkbox" checked>为轮播图change事件添加第二参数source
	- 上传文件组件    
	    · <input type="checkbox">优化上传文件组件，添加flex-wrap字段
3. ⭐⭐⭐完善组件预览网站
4. ⭐组件替换
