...
4. ⭐<input type="checkbox">了解，预研vscode插件，为后续开发组件库的vscode插件做准备
5. ⭐<input type="checkbox">后续功能，计划探讨和研究
6. ⭐<input type="checkbox">vue2模版新增路由校验功能


<span  style="color:red;">2024/09/23 - 2024/09/30 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐组件移植
	- <input type="checkbox">Select 下拉选
	- <input type="checkbox">IndexList 索引列表
	- <input type="checkbox">NumberKeyboard 数字键盘
	- <input type="checkbox">IndexList Animate 动画
	- <input type="checkbox">MessageBox 弹框
	- <input type="checkbox">NoticeBar 公告栏
2. ⭐⭐⭐组件迭代 
	- 轻提示组件  
...
3. ⭐持续优化网站功能和文档
	...
	- <input type="checkbox">评论新增多级评论功能
	- <input type="checkbox">vue3:移植评论功能
...
<span  style="color:#07C160;text-decoration: line-through;">月度计划：预计时间2024/08/05-2024/08/30</span> 
1. ⭐⭐⭐完成19个左右组件的移植
