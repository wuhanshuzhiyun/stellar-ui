...
<span style="color:red;">月度计划：2024/06/03-2024/06/28</span> 
1. ⭐⭐⭐<input type="checkbox">完成7个左右组件的开发，2个模块开发
2. ⭐⭐⭐<input type="checkbox">新增微信小程序预览版
3. ⭐⭐<input type="checkbox">组件迭代
	- 评分组件    
	    · <input type="checkbox">根据比例由左向右展示，可配置不同比例展示不同图标
4. ⭐<input type="checkbox">持续优化网站功能和文档
5. ⭐<input type="checkbox">新增自定义主题功能

<span  style="color:red;">2024/06/24 - 2024/06/28 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">Animate 动画/动效
	- <input type="checkbox">Signature 签名
	- <input type="checkbox">MessageBox 弹窗组件
	

<span  style="color:red;">2024/06/17 - 2024/06/21 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">Table 表格
	- <input type="checkbox">Tour 引导
2. ⭐⭐⭐完善组件预览网站
	- 弹窗组件    
	    · <input type="checkbox">新增函数式使用方法
	- 轻提示组件    
	    · <input type="checkbox">解决系统自带弹窗共存的问题
	- 单选框组件和复选框组件    
	    · <input type="checkbox">图标插槽增加readonly状态判断
3. ⭐组件替换
