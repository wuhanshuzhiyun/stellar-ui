...
<span style="color:red;">2024/4/15 - 2024/4/19 开发计划：</span>  
**开发人员：秦鹏飞，张园因，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">ImagePreview 图片预览组件
	- <input type="checkbox">Popup 弹出层组件
2. ⭐⭐组件迭代
	- 按钮组件  
		· <input type="checkbox" checked>解决按钮组件在禁止状态下 hover-class一直存在的问题
	- 手势切屏件  
		· <input type="checkbox">增加属性，向Swipe靠齐，优化说明文档和demo
	- 徽标组件      
