...
<span style="color:red;">2024/3/11- 2024/3/15 部分开发计划：</span>  
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox" >标签栏组件
	- <input type="checkbox" >标记组件
2. ⭐⭐⭐<input type="checkbox">使用现有组件库替换支付宝小程序其对应的功能
3. ⭐⭐⭐<input type="checkbox">修改业务组件button，price，支付宝替换
4. ⭐⭐⭐<input type="checkbox">推动和协助图标库的创建和完善
	- 修改图标组件的娱乐效果（code显示换一种方式）
5. ⭐⭐<input type="checkbox">新增微信小程序预览版（体验版小程序），推动ui库的微信小程序和支付宝小程序账号创建。
	- 找刘园申请微信和支付版小程序账号
	- 找刘园申请新的域名和公网网站，
6. ⭐<input type="checkbox">完善组件预览网站
7. ⭐⭐<input type="checkbox">开放给其他人使用
	- 需要和ui沟通，ui使用ui库现有几个组件去重新设计支付宝的首页
	- 让其余人使用组件库组件进行开发

<span style="color:#1989FA;">2024/3/4- 2024/3/8 开发计划：</span>  
