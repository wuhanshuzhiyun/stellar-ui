...
<span style="color:red;">2024/4/8 - 2024/4/12 开发计划：</span>  
**开发人员：秦鹏飞，张园因，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">Stepper 步进器组件
	- <input type="checkbox">Slider 滑块组件
	- <input type="checkbox">Upload 上传组件
2. ⭐⭐组件迭代
	- 按钮组件  
		· <input type="checkbox" checked>解决支付宝小程序中rootStyle属性失效的问题
3. ⭐⭐⭐完善组件预览网站  
	-  <input type="checkbox" checked>评分，开关，单选框和复选框rpx使用utils.rpx2px方法替换
4. 组件替换
