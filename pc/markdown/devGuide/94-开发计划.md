...
2. ⭐<input type="checkbox">轻提示组件增加组合函数用法和全局挂载用法
3. ⭐<input type="checkbox">了解，预研vscode插件，为后续开发组件库的vscode插件做准备


<span  style="color:red;">2024/09/09 - 2024/09/14 开发计划：</span>  
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐组件移植
	- <input type="checkbox">Slider 滑块
	- <input type="checkbox">DropdownMenu 下拉菜单
	- <input type="checkbox">IndexList 索引列表
	- <input type="checkbox">Animate 动画

2. ⭐⭐⭐组件迭代 
	- 富文本组件  
		· <input type="checkbox">解决富文本错误换行的问题
	- Vscode插件  
