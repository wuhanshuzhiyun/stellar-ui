...
1. 皮肤功能
2. 多语言功能
3. <input type="checkbox">增加简易的登录功能，登录后展示研发组内容
4. 打印日志的管理
5. 新增小程序预览版
6. 小范围的组件库测试
7. 富文本组件添加折叠功能
...
<span style="color:red;">月度计划：预计时间2024/05/06-2024/05/31</span> 
1. ⭐⭐⭐完成10个左右组件的开发
2. ⭐⭐⭐新增微信小程序预览版
3. ⭐持续优化网站功能和文档
	- 增加简易的登录功能，登录后展示研发组内容
4. ⭐⭐可提供给开发人员使用

5. ⭐⭐组件props添加属性类型判断和用法判断，错误抛出error

<span style="color:red;">2024/5/6 - 2024/5/11 开发计划：</span>  
**开发人员：秦鹏飞，张园因，徐亚军，付宇威**
1. ⭐⭐⭐增加组件数量（先预研确定组件功能和样式，再开发）（兼容支付宝）
	- <input type="checkbox">DatePicker 日期选择器组件
	- <input type="checkbox">ActionSheet 动作面板组件
	- <input type="checkbox">Calendar 日历组件
2. ⭐⭐组件迭代
	- <input type="checkbox">增加简易的登录功能，登录后展示研发组内容
3. ⭐⭐⭐完善组件预览网站
4. ⭐组件替换
