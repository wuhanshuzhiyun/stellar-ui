...
<span  style="color:red;">2024/09/02 - 2024/09/06 开发计划：</span>
**开发人员：秦鹏飞，徐亚军，付宇威**
1. ⭐⭐组件移植
	- <input type="checkbox">继续SwipeAction 滑动单元格
	- <input type="checkbox">Tour 指引
	- <input type="checkbox">RichText 富文本
	- <input type="checkbox">Steps 步骤条
	- <input type="checkbox">Stepper 步进器
2. ⭐⭐⭐组件迭代 
	- 视频组件  
		· <input type="checkbox">切换清晰度和播放速率增加提示
    #### v3:
	- 表格组件  
		· <input type="checkbox">使用组件库复选框和单选框
